...
const Loading = styled.div`
  ...
  .ldio-mr3gmr920vk div:nth-child(1) {
    background: #689cc5;
    transform: translate(148px, 80px) scale(1);
    animation: ldio-mr3gmr920vk-r 0.25s infinite cubic-bezier(0, 0.5, 0.5, 1),
      ldio-mr3gmr920vk-c 1s infinite step-start;
  }
...
const Loader = () => {
  return (
    <Loading>
      <div class="loadingio-spinner-ellipsis-9x1tpm4e0y">
        <div class="ldio-mr3gmr920vk">
          <div></div>
          <div></div>
          <div></div>
          <div></div>
